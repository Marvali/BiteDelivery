 ...
 * @author isaac
 */
public class ObsoletoMenuInicial extends javax.swing.JFrame implements Serializable  {

    /**
     * Creates new form menu
     */
   
    public ObsoletoMenuInicial() {
    ...
    private void iniciarSesionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iniciarSesionMouseClicked
        // TODO add your handling code here:
        ObsoletoMenuIniciarSesion menu = new ObsoletoMenuIniciarSesion(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ObsoletoMenuInicial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ObsoletoMenuInicial().setVisible(true);
            }
        });
    }
