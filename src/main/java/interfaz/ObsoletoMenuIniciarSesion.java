 ...
 * @author isaac
 */
public class ObsoletoMenuIniciarSesion extends javax.swing.JFrame implements Serializable {
private ObsoletoMenuInicial prueba;
    /**
     * Creates new form MenuLogin
     */
    public ObsoletoMenuIniciarSesion(ObsoletoMenuInicial ventana) {
        initComponents();
        prueba=ventana;
    ...
    public ObsoletoMenuIniciarSesion() {
    }
    ...
    private void buttonLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonLoginActionPerformed
        ...
        if(loginEmpresa(correo,contraseña)){
            ...
            ObsoletoMenuIniciarSesion.this.dispose();
            //
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ObsoletoMenuIniciarSesion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
